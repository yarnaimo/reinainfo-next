...
const renderer: Renderer<_SchemaType> = ({
  ...
  const [previewSchedule, setPreviewSchedule] = useState<IScheduleSerialized>()
    ...
    <>
      ...
      <form ref={formRef}>
        ...
        <Section>
          ...
          <FormRow>
            <TextField {...textarea} {...field('title')}></TextField>
          </FormRow>
          <FormRow>
        ...
        <Section>
          ...
          {ticketForm.renderAddButton(() =>
            ticketForm.editDoc(model!.collectionRef.doc(), model!.create),
          )}
          <AdminDataTable
